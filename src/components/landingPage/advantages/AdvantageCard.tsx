...
export function AdvantageCard({ title, detailing, link }: IAdvantageCardProps) {
	return (
		<div className="h-[225px] flex flex-col gap-4 px-6 py-8 bg-gray100 rounded-md shadow-sm shadow-gray400">
			<h1 className="text-2xl font-bold text-black">{title}</h1>

			<p className="text-lg font-light text-black">{detailing}</p>
